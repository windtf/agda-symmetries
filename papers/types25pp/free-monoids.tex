...
%
Using the universal property allows us to define and prove our programs correct in one go,
...
%
\begin{definition}[\alink{definition}{Lists}]
    \label{def:lists}
    \leavevmode
    \begin{code}
...
\begin{propositionrep}[\alink{proposition}{Universal property for List}]
...
\begin{definition}[\alink{definition}{Arrays}]
    \label{def:arrays}
    \leavevmode
    \begin{code}
Array : UU -> UU
...
For brevity, we write $S$ for the successor function on natural numbers.

\begin{lemmarep}[\alink{lemma}{Array cons}]
    \label{array:eta-suc}
...
\begin{lemmarep}[\alink{lemma}{Array split}]
    \label{array:split}
...
\begin{propositionrep}[\alink{proposition}{Universal property for Array}]
    \label{array:univ}
    \leavevmode
