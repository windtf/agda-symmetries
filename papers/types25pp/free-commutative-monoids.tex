...
\begin{definition}[\alink{definition}{PList}]
    The inductive family $\Perm$ defines a permutation relation on $\List$,
    and is generated by two constructors:
    \begin{align*}
...
\end{definition}
%
By~\cref{cmon:qfreemon}, it suffices to show $\Perm(A)$ satisfies the axioms of permutation relation
to show $\PList(A)$ is the free commutative monoid.
