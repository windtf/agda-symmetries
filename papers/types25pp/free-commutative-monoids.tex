...
\begin{proof}
    ...
    Note that both $f$ and $\quotient$ are homomorphism, therefore $f \comp q$ is a homomorphism. By
...
saving the efforts of defining auxillary lemmas to prove their equality.
...
%
\begin{definition}[\alink{definition}{$\SList$}]
    \label{def:slist}
