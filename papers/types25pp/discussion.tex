...
\citeauthor{hengleinSortingSearchingDistribution2013}~\cite{hengleinWhatSortingFunction2009},
studies sorting functions abstractly,
...
%
Unlike us,
%% \citeauthor*{hengleinWhatSortingFunction2009}
does not factorize the sorting function
through free commutative monoids, but the ideas are extremely similar.
His work also focuses on preorders where antisymmetry may not hold,
whereas we focus on total orders.
%
...
% Their formalisation is defined in terms of bialgebras, which not
