...
that predates the Lawvere theory or abstract clone point of view~\cite{lawvereFunctorialSemanticsAlgebraic1963,hylandCategoryTheoreticUnderstanding2007}.
%
...
\begin{example}
    ...
    %
    Informally, we denote this two-element list of operations as a tuple $(e,\mult)$.
\end{example}
