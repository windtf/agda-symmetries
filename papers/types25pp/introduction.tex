...
\begin{myitemize}
  ...
  \item All the results of this paper are formalized in Cubical Agda, which is discussed in~\cref{sec:formalization}.
...
%
Readers interested in the formalization of universal algebra may start from~\cref{sec:universal-algebra}.
%
...
%
\ifarxiv{}{The extended version of this paper including additional formalization details and proofs is available on arXiv.}i
%
The formalization artifact is available at~\cite{choudhuryAgdasymmetries2025}.