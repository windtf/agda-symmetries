...
To make the type levels explicit, $A$ is of type level $\ell$, and since $\hProp_\ell$
...
and instead use Agda's universe polymorphism in our formalisation to accommodate this.
