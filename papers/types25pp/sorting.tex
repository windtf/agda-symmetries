...
\end{proof}
%
We can show that giving a decidable strict total order structure on $A$ is equivalent to giving a decidable total order structure on $A$.
...
\begin{proposition}[\alink{proposition}{}{total-order-meet-semi-lattice}]
    ...
    A total order $\leq$ on a set $A$ is equivalent to a total meet semi-lattice structure on $A$.
